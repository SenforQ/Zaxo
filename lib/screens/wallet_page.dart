...
const List<CoinProduct> kCoinProducts = [
  CoinProduct(productId: 'ios_Zaxo_0_9', coins: 32, price: 0.99, priceText: '\$0.99'),
  CoinProduct(productId: 'ios_Zaxo_1_9', coins: 60, price: 1.99, priceText: '\$1.99'),
  CoinProduct(productId: 'ios_Zaxo_2_9', coins: 96, price: 2.99, priceText: '\$2.99'),
  CoinProduct(productId: 'ios_Zaxo_4_9', coins: 155, price: 4.99, priceText: '\$4.99'),
  CoinProduct(productId: 'ios_Zaxo_5_9', coins: 189, price: 5.99, priceText: '\$5.99'),
  CoinProduct(productId: 'ios_Zaxo_9_9', coins: 359, price: 9.99, priceText: '\$9.99'),
  CoinProduct(productId: 'ios_Zaxo_19_9', coins: 729, price: 19.99, priceText: '\$19.99'),
  CoinProduct(productId: 'ios_Zaxo_49_9', coins: 1869, price: 49.99, priceText: '\$49.99'),
  CoinProduct(productId: 'ios_Zaxo_99_9', coins: 3799, price: 99.99, priceText: '\$99.99'),
];
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (mounted) _handleConfirmPurchase();
            },
